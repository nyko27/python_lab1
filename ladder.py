class Ladder():
	...
	def __str__(self):
		return 	self.producer + ',' + str(self.max_length_in_metres) + ',' + str(self.max_load) + ',' + self.material + ',' + str(self.width) + ',' + str(self.mass_in_kilograms) + ',' + str(self.warranty_in_years)
